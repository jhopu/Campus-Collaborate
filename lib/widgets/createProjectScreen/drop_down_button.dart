...
class CustomDropDownButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text('Time Taken', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),),
              ...
              child: Center(
                child: Consumer<DropDownServices>(
                  builder: (context, services, child)=>DropdownButton<String>(
                    items: DropDownServices.durationItems.map<DropdownMenuItem<String>>((String value) {
                    ...
                    dropdownColor: Themes.getColors(ColorsValues.LIGHT_GREY_COLOR),
                  ),
                ),
              ),
            ),
