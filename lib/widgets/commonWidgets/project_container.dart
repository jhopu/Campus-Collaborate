...
class ProjectContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return project.urls==null||project.urls!.isEmpty?Expanded(child: ProjectContainerWithoutImage(project: project)):Expanded(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
                ...
                child: Image.network(project.urls![0], height: 100, width: double.infinity,)),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(project.projectName, style: const TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w500),),
              Text(project.admin==null?'Individual Project':'Group Project', style: const TextStyle(fontSize: 10,color: Colors.white, fontWeight: FontWeight.w400),)
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
